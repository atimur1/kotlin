...
//    private val explicitLibraries = emptyList<Pair<String, String>>() /*listOf(
...
//            val artifactName = dependency.name.substringBeforeLast(".src").substringBeforeLast(".test")
//
//            if (artifactName == "kotlin-compiler" || artifactName == "kotlin-stdlib-js") {
//                return null
//            }
//
//            if (artifactName == "kotlin-reflect-api") {
//                return PDependency.Library("kotlin-reflect")
//            }
//
//            if (artifactName in distLibraries || artifactName in otherSpecialDependencies) {
//                return PDependency.Library(artifactName)
//            }
//        }
//
//        return dependency
